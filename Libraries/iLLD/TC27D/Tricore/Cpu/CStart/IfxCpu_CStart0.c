...
#ifdef IFX_SSW_PREMAIN
#ifdef __TASKING__
extern void _main(void); /*constructor initialization */
#endif
#ifdef __GCC__
extern void _init(void); /*constructor initialization */
#endif
#ifdef __HIGHTEC__
extern void _init(void); /*constructor initialization */
#endif
...
#ifdef IFX_SSW_POSTMAIN
#ifdef __TASKING__
extern void _doexit(void); /*destructor deinitialization */
#endif
#ifdef __GCC__
extern void _exit(int status); /*destructor deinitialization */
#endif
#ifdef __HIGHTEC__
extern void _exit(int status); /*destructor deinitialization */
#endif
